...
public class CelebornSaslClient {
  ...
  public CelebornSaslClient(
    ...
    this.saslMechanism = Preconditions.checkNotNull(saslMechanism);
    try {
      this.saslClient =
          Sasl.createSaslClient(
              new String[] {saslMechanism}, null, null, DEFAULT_REALM, saslProps, callbackHandler);
  ...
  public static class ClientCallbackHandler implements CallbackHandler {
    ...
    public ClientCallbackHandler(String appId, String password) {
    ...
    public void handle(Callback[] callbacks) throws UnsupportedCallbackException {
      ...
      for (Callback callback : callbacks) {
        if (callback instanceof NameCallback) {
          ...
          nc.setName(encodeIdentifier(appId));
