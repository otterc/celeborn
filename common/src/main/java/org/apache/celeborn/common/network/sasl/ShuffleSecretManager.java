...
public class ShuffleSecretManager implements SecretKeyHolder {
  ...
  /**
   * Register an application with its secret. Executors need to first authenticate themselves with
   * the same secret before fetching shuffle files written by other executors in this application.
   */
  ...
  /**
   * Unregister an application along with its secret. This is called when the application
   * terminates.
   */
  ...
  /**
   * Return the secret key registered with the given application. This key is used to authenticate
   * the executors before they can fetch shuffle files written by this application from the external
   * shuffle service. If the specified application is not registered, return null.
   */
  @Override
