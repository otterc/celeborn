...
class PbSerDeUtilsTest extends CelebornFunSuite {
  ...
  val workerInfo1 =
    new WorkerInfo("localhost", 1001, 1002, 1003, 1004, 1005, diskInfos, userResourceConsumption)
  val workerInfo2 =
    new WorkerInfo("localhost", 2001, 2002, 2003, 2004, 2005, diskInfos, userResourceConsumption)
